...
if uploaded_file:
    ...
    st.success(f"Video Loaded: {int(duration)} sec, {int(fps)} FPS, {total_frames} frames")
    ...
    while cap.isOpened():
        ...
        if frame_id % 5 == 0:
            ...
            cv2.imwrite(f"output/annotated_frames/annotated_{processed_id:04d}.jpg", frame)
    ...
    with open(json_path, "rb") as f:
        st.download_button("📥 Download detection_summary.json", f, file_name="detection_summary.json")
